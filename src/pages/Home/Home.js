    ...
    <div>
      <div className="hero-container">
        <div className="container text-center">
          ...
          <a className="btn btn-main" href="/appointment" role="button">
            Book an Appointment
          </a>
        </div>
      </div>
      ...
      <div className="white-container-5 text-center">
        <h2 className="about-header-main">
          Customizable healthcare when and where you need it most
        </h2>
        <div className="container-lg py-5">
          <div className="row g-4 mx-auto mb-4">
            <div
              className="col-lg-2 full-screen"
              style={{ width: "12.5%" }}
            ></div>
            <div className="col-lg-3 col-md-4 text-center">
              <a href="/covid-19" className="btn btn-service">
                <img
                  ...
                  src="assets/img/covid-testing-img.png"
                />
            ...
            <div className="col-lg-3 col-md-4 text-center">
              <a href="/urgent-care" className="btn btn-service">
                <img
                  className="service-icon-img"
                  src="assets/img/trauma-care-img.png"
                />
            ...
            <div className="col-lg-3 col-md-4 text-center">
              <a href="/pediatrics" className="btn btn-service">
                <img
                  className="service-icon-img"
                  src="assets/img/pediatric-care-img.png"
                />
            ...
            <div className="col-lg-3 col-md-4 text-center">
              <a href="/prevention" className="btn btn-service">
                <img
                  className="service-icon-img"
                  src="assets/img/womens-health-img.png"
                />
            ...
            <div className="col-lg-3 col-md-4 text-center">
              <a href="/allergies-asthma" className="btn btn-service">
                <img
                  className="service-icon-img"
                  src="assets/img/allergies-img.png"
                />
            ...
            <div className="col-lg-3 col-md-4 text-center">
              <a href="/vaccines" className="btn btn-service">
                <img
                  className="service-icon-img"
                  src="assets/img/vaccination-img.png"
                />
        ...
        <a className="btn btn-main mt-3" href="/nyc-urgent-care-services">
      ...
      <div className="grey-container text-center">
        ...
        <div className="mx-auto text-center">
          <a className="btn btn-lite-red mt-5" href="/locations" role="button">
            See all of our NYC locations
          </a>
        </div>
      </div>
      <div className="white-container-5 container-lg">
        <div className="container-lg text-center">
          <h2 className="about-header-main">
            We’re making accessing medical care easy and convenient
          </h2>
      ...
      <div className="red-container text-center">
        ...
        <p className="doctor-text mt-5">
          ...
          convenient location-based hours, throughout New York City. Schedule an
        ...
        <div className="row g-5 container-lg mx-auto my-4">
          <div className="col-lg-4 col-md-6 text-center">
            ...
            <p className="doctor-text">
              ...
              more complicated or vulnerable care visits, we may recommend
              patients visit one of our full service urgent care centers around
              the NYC area.
            </p>
          </div>
          <div className="col-lg-4 col-md-6 text-center">
            ...
            <p className="doctor-text">
              ...
              that we’re strategically parking throughout the NYC area and five
              boroughs.
            </p>
          </div>
          <div className="col-lg-4 col-md-6 text-center">
        ...
        <a
          className="btn btn-lite-red mt-5"
      ...
      <div className="white-container-5 container">
        <div className="row w-100 mx-0">
          ...
          <div className="col-lg-6 order-1 order-lg-5 d-flex flex-column justify-content-center">
            <h2 className="section-header-second text-lg-end text-center">
              Say hello when you walk by
            </h2>
            <h2 className="section-header-main text-lg-end text-center">
            ...
            <div className="text-center mt-4">
              <a href="/locations" className="btn btn-red">
      ...
      <div className="doctor-container">
        <div className="container-lg">
          <h2 className="section-header-white pb-5">
      ...
      <div className="white-container-3 goodbye-container">
        <div className="row">
          <div className="col-lg-5 goodbye-heading">
            <h2 className="goodbye-heading-text text-center text-lg-start">
              Say goodbye to…
            </h2>
          </div>
      ...
      <div className="health-lib-container d-flex flex-column justify-content-center">
        <h2 className="section-header-second text-lg-start text-center">
          We help you care for
        </h2>
        <h2 className="section-header-main text-lg-start text-center">
          Yourself and Your Family
        </h2>
        <p className="health-text">
          Check out these wellness tips and the research that backs them up to
          better understand how to optimize your health and nutrition.
        </p>
          ...
          <div className="col-lg-4 col-md-6">
            <a href="/blog1">
              <div className="card health-lib-card">
                ...
                />
                <div className="card-body">
                  <h5 className="blog-header">
                    What's The Difference Between CBC And CMP Blood Tests?
                  </h5>
                  <p className="blog-tldr">
                    There’s a good deal that your blood can tell us about your
                    health. To access that information, we can perform a
                    complete blood count (CBC) and a comprehensive metabolic
                    panel (CMP). Here’s a look at the difference between the
                    two.
                  </p>
                </div>
              </div>
            ...
            <a href="/blog2">
              <div className="card health-lib-card">
                ...
                <div className="card-body">
                  ...
                  <p className="blog-tldr">
                    As our nation watches anxiously as new variants of COVID-19
                    emerge, the return to safety measures, such as masking up
                    and social distancing, may come back. For this reason, and
                    many others, telehealth may make perfect sense.
                  </p>
                </div>
              </div>
            </a>
            ...
            <a href="/blog3">
              <div className="card health-lib-card">
                ...
                <div className="card-body">
                  ...
                  <p className="blog-tldr">
                    The month of August can be a hot and sticky one here in New
                    York City, which makes us more vulnerable to heat-related
                    illnesses. To beat the heat this summer, we take a closer
                    look at the problem.
                  </p>
                </div>
              </div>
