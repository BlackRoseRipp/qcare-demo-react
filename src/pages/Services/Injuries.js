...
const Injuries = () => {
  return (
    <Fragment>
      ...
      <div className="container mx-auto py-24">
        <h2 className="text-4xl font-semibold text-center text-blue-primary">
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-16 lg:gap-y-32 mt-32 w-11/12 mx-auto">
          ...
          <div className="order-1 lg:order-2 flex flex-col justify-evenly lg:items-start items-center">
            <h3 className="text-blue-primary text-4xl text-center font-medium">
              Broken Bones
            </h3>
            <p className="text-blue-secondary text-lg text-center lg:text-start lg:w-3/4 w-5/6 lg:mx-0 mx-auto mt-4">
            ...
            <div className="flex flex-col justify-center lg:items-start items-center mt-4">
              <p className="text-blue-secondary text-lg text-center lg:text-start mb-4">
              ...
              <div className="flex items-center justify-start w-fit my-1">
                <IoIosMedical className="text-2xl text-blue-logo-secondary mr-2" />
                <h5 className="text-blue-secondary text-lg">Intense pain</h5>
              </div>
              <div className="flex items-center justify-start w-fit my-1">
                <IoIosMedical className="text-2xl text-blue-logo-secondary mr-2" />
                <h5 className="text-blue-secondary text-lg">
          ...
          <div className="order-3 flex flex-col justify-evenly lg:items-start items-center">
            ...
            <div className="flex flex-col justify-center lg:items-start items-center mt-4">
              ...
              <div className="flex items-center justify-start w-fit my-1">
                <IoIosMedical className="text-2xl text-blue-logo-secondary mr-2" />
                <h5 className="text-blue-secondary text-lg">Swelling</h5>
              </div>
              <div className="flex items-center justify-start w-fit my-1">
                <IoIosMedical className="text-2xl text-blue-logo-secondary mr-2" />
                <h5 className="text-blue-secondary text-lg">
      ...
      <div className="bg-blue-secondary/10 py-8">
        <div className="py-16 bg-[url(../public/img/patterns/Q-logo-pattern.svg)] bg-center bg-no-repeat bg-contain">
          <div className="container mx-auto">
            ...
            <p className="text-blue-logo-primary text-center text-xl font-medium mt-16 lg:w-2/3 w-5/6 mx-auto">
