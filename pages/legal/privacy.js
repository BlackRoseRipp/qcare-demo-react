  ...
  return (
    <Fragment>
      ...
      <div className="container mx-auto py-24">
        <h3 className="heading text-2xl mb-7 font-medium">Privacy Policy</h3>
        <p className="mb-4">
        ...
        <h6 className="mb-2 font-bold">Types of Data Collected</h6>
        <h6 className="mb-2 font-bold">Personal Data</h6>
        <p className="mb-4">
        ...
        <h6 className="mb-2 font-bold">Usage Data</h6>
        <p className="mb-4">
        ...
        <h6 className="mb-2 font-bold">Tracking Technologies and Cookies</h6>
        <p className="mb-4">
        ...
        <h6 className="mb-2 font-bold">Necessary / Essential Cookies</h6>
        <ul className="ml-8 mb-4">
          <li>
        ...
        <h6 className="mb-2 font-bold">Functionality Cookies</h6>
        <ul className="ml-8 mb-4">
          <li>
            <p className="mb-4">Type: Persistent Cookies</p>
          </li>
        ...
        <h6 className="mb-2 font-bold">Tracking and Performance Cookies</h6>
        <ul className="ml-8 mb-4">
          <li>
            <p className="mb-4">Type: Persistent Cookies</p>
          </li>
        ...
        <h6 className="mb-2 font-bold">Business Transactions</h6>
        <p className="mb-4">
        ...
        <h6 className="mb-2 font-bold">Law enforcement</h6>
        <p className="mb-4">
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h6 className="mb-2 font-bold">Other legal requirements</h6>
        <p className="mb-4">
        ...
        <h6 className="mb-2 font-bold">Security of Your Personal Data</h6>
        <p className="mb-4">
        ...
        <h3 className="heading text-2xl mb-7 font-medium">Analytics</h3>
        <p className="mb-4">
        ...
        <ul className="ml-8 mb-4">
          <li>
            <h6 className="mb-2 font-bold">Google Analytics</h6>
          </li>
          <li>
            <p className="mb-4">
        ...
        <h3 className="heading text-2xl mb-7 font-medium">Email Marketing</h3>
        <p className="mb-4">
        ...
        <ul className="ml-8 mb-4">
          <li>
            <h6 className="mb-2 font-bold">Klaviyo</h6>
          </li>
          <li>
            <p className="mb-4">
